...
Microsoft recently released [Foundry Local](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/get-started?view=foundry-classic) which is a way to run the powerful Microsoft Foundry locally. This enables you to run OSS AI models available in Foundry also locally - which is super compelling.
...
{{< figure src="/images/foundry-local.gif" >}}
