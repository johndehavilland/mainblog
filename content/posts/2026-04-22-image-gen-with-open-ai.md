...
{{< figure src="/images/quantum-info.png" caption="Prompt: " 

I even had it build an infographic on how headshots can be created using AI.

{{< figure src="/images/headshot-info.png" caption="Prompt: " >}}

## Headshots
GPT-Image-2 does great at creating professional headshots too with a few sample images. I can provide a sample image and some direction and it will generate a professional looking headshot rapidly.
...
## Just for fun
It can even generate comic strips for you in the style of your choosing. Here I took a super fun interaction I had with my daughter and turned it into a memory I could frame.
